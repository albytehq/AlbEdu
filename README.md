...
[![Version](https://img.shields.io/badge/version-v0.818.1-blue)]()
...
## 📁 Project Structure (v0.818.1 — By-Feature)
...
| [docs/asset-system/ROADMAP.md](./docs/asset-system/ROADMAP.md) | 🆕 Asset system migration roadmap (v0.818.1+) |
...
### Current State (v0.818.1 — Phase 0 complete)
