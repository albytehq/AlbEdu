...
**Last verified:** 2026-07-08 (v0.821.0)
...
Key new patterns to know about when working in v0.821.0+ code:

### Migration `20260708_021_v0815_7_stability_hardening.sql`

Apply this migration before deploying the v0.821.0 Edge Functions. It contains:
