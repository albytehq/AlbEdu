...
`;
  ...
  var _CRITICAL_I18N = {
    id: {
      ...
      'common.copyright': '© {{year}} AlbEdu. Semua hak dilindungi.',
      'common.year_copyright': '&copy; {{year}} AlbEdu. Hak cipta dilindungi.',
      'nav.active_assessments': 'Asesmen Aktif',
      'nav.admin_app': 'AlbEdu Admin',
      'nav.admin_card_creates_aria': 'Buka AlbEdu Creates',
      'nav.admin_card_creates_desc': 'Buat dan kelola konten pembelajaran untuk platform AlbEdu.',
      'nav.admin_card_creates_title': 'AlbEdu Creates',
      'nav.admin_card_ujian_aria': 'Buka Halaman Ujian',
      'nav.admin_card_ujian_desc': 'Kelola sistem ujian online dan pantau hasil ujian peserta.',
      'nav.admin_card_ujian_title': 'Halaman Ujian',
      'nav.admin_greeting': 'Panel Administrator',
      'nav.admin_notification_aria': 'Notifikasi pelanggaran ujian',
      'nav.admin_panel': 'Panel Administrator',
      'nav.admin_status_bar': 'AlbEdu Admin Panel',
      'nav.asesmen_desc': 'Buka halaman input kode akses peserta untuk uji coba, inspeksi alur, atau pemantauan sesi asesmen.',
      'nav.asesmen_title': 'Halaman Asesmen',
      'nav.close_sidebar': 'Tutup sidebar',
      'nav.create_assessment': 'Buat Asesmen',
      'nav.creates_desc': 'Pusat kendali administrator — kelola profil, preferensi, dan identitas akun AlbEdu Anda dari satu tempat.',
      'nav.creates_kicker': 'Workspace admin',
      'nav.daftar_nama': 'Daftar Nama',
      'nav.default_admin_name': 'Admin',
      'nav.greet_afternoon': 'Selamat Siang, {{name}}!',
      'nav.greet_evening': 'Selamat Sore, {{name}}!',
      'nav.greet_morning': 'Selamat Pagi, {{name}}!',
      'nav.greet_night': 'Selamat Malam, {{name}}!',
      'nav.monitoring': 'Monitoring',
      'nav.open_asesmen_aria': 'Buka Halaman Asesmen',
      'nav.open_creates_aria': 'Buka AlbEdu Creates',
      'nav.open_sidebar': 'Buka sidebar',
      'nav.peserta_kicker': 'Sisi peserta',
      'nav.profile': 'Profil Admin',
      'nav.profile_incomplete': 'Profil belum lengkap',
      'nav.profile_incomplete_short': 'Profil belum lengkap',
      'nav.question_bank': 'Bank Soal',
      'nav.results': 'Hasil & Analitik',
      'nav.role_admin': 'Administrator',
      'nav.role_admin_alt': 'Admin AlbEdu',
      'nav.status_bar': 'AlbEdu Admin Panel · v0.742.9',
      'nav.welcome_back': 'Selamat datang kembali. Pilih ruang kerja Anda di bawah ini.'
    },
    en: {
      'landing.nav_login': 'Login',
      ...
      'admin.profile.role_badge': 'Administrator',
      'common.copyright': '© {{year}} AlbEdu. All rights reserved.',
      'common.year_copyright': '&copy; {{year}} AlbEdu. All rights reserved.',
      'nav.active_assessments': 'Active Assessments',
      'nav.admin_app': 'AlbEdu Admin',
      'nav.admin_card_creates_aria': 'Open AlbEdu Creates',
      'nav.admin_card_creates_desc': 'Create and manage learning content for the AlbEdu platform.',
      'nav.admin_card_creates_title': 'AlbEdu Creates',
      'nav.admin_card_ujian_aria': 'Open Exams Page',
      'nav.admin_card_ujian_desc': 'Manage the online exam system and monitor participant exam results.',
      'nav.admin_card_ujian_title': 'Exams Page',
      'nav.admin_greeting': 'Administrator Panel',
      'nav.admin_notification_aria': 'Exam violation notifications',
      'nav.admin_panel': 'Administrator Panel',
      'nav.admin_status_bar': 'AlbEdu Admin Panel',
      'nav.asesmen_desc': 'Open the participant access code input page for testing, flow inspection, or assessment session monitoring.',
      'nav.asesmen_title': 'Assessment Page',
      'nav.close_sidebar': 'Close sidebar',
      'nav.create_assessment': 'Create Assessment',
      'nav.creates_desc': 'Administrator control center — manage your profile, preferences, and AlbEdu account identity from one place.',
      'nav.creates_kicker': 'Workspace admin',
      'nav.daftar_nama': 'Name List',
      'nav.default_admin_name': 'Admin',
      'nav.greet_afternoon': 'Good Afternoon, {{name}}!',
      'nav.greet_evening': 'Good Evening, {{name}}!',
      'nav.greet_morning': 'Good Morning, {{name}}!',
      'nav.greet_night': 'Good Night, {{name}}!',
      'nav.monitoring': 'Monitoring',
      'nav.open_asesmen_aria': 'Open Assessment Page',
      'nav.open_creates_aria': 'Open AlbEdu Creates',
      'nav.open_sidebar': 'Open sidebar',
      'nav.peserta_kicker': 'Participant side',
      'nav.profile': 'Admin Profile',
      'nav.profile_incomplete': 'Profile incomplete',
      'nav.profile_incomplete_short': 'Profile incomplete',
      'nav.question_bank': 'Question Bank',
      'nav.results': 'Results & Analytics',
      'nav.role_admin': 'Administrator',
      'nav.role_admin_alt': 'AlbEdu Admin',
      'nav.status_bar': 'AlbEdu Admin Panel · v0.742.9',
      'nav.welcome_back': 'Welcome back. Choose your workspace below.'
    }
  };
  ...
  //
  // IMPORTANT: window.AlbEdu might not exist yet at this point (it's
  // initialized later in this file). Ensure it exists before setting props.
